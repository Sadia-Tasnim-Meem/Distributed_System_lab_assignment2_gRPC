...
public final class userGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.User.registrationReq,
      com.demo.grpc.User.APIRes> getRegisterMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Register",
      requestType = com.demo.grpc.User.registrationReq.class,
      responseType = com.demo.grpc.User.APIRes.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.grpc.User.registrationReq,
      com.demo.grpc.User.APIRes> getRegisterMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.User.registrationReq, com.demo.grpc.User.APIRes> getRegisterMethod;
    if ((getRegisterMethod = userGrpc.getRegisterMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getRegisterMethod = userGrpc.getRegisterMethod) == null) {
          userGrpc.getRegisterMethod = getRegisterMethod = 
              io.grpc.MethodDescriptor.<com.demo.grpc.User.registrationReq, com.demo.grpc.User.APIRes>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "user", "Register"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.User.registrationReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.User.APIRes.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.User.updateReq,
      com.demo.grpc.User.APIRes> getUpdateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Update",
      requestType = com.demo.grpc.User.updateReq.class,
      responseType = com.demo.grpc.User.APIRes.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.grpc.User.updateReq,
      com.demo.grpc.User.APIRes> getUpdateMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.User.updateReq, com.demo.grpc.User.APIRes> getUpdateMethod;
    if ((getUpdateMethod = userGrpc.getUpdateMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getUpdateMethod = userGrpc.getUpdateMethod) == null) {
          userGrpc.getUpdateMethod = getUpdateMethod = 
              io.grpc.MethodDescriptor.<com.demo.grpc.User.updateReq, com.demo.grpc.User.APIRes>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "user", "Update"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.User.updateReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.User.APIRes.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.User.viewReq,
      com.demo.grpc.User.viewRes> getViewProfileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ViewProfile",
      requestType = com.demo.grpc.User.viewReq.class,
      responseType = com.demo.grpc.User.viewRes.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.grpc.User.viewReq,
      com.demo.grpc.User.viewRes> getViewProfileMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.User.viewReq, com.demo.grpc.User.viewRes> getViewProfileMethod;
    if ((getViewProfileMethod = userGrpc.getViewProfileMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getViewProfileMethod = userGrpc.getViewProfileMethod) == null) {
          userGrpc.getViewProfileMethod = getViewProfileMethod = 
              io.grpc.MethodDescriptor.<com.demo.grpc.User.viewReq, com.demo.grpc.User.viewRes>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "user", "ViewProfile"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.User.viewReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.User.viewRes.getDefaultInstance()))
                  .setSchemaDescriptor(new userMethodDescriptorSupplier("ViewProfile"))
                  .build();
          }
        }
     }
  ...
  public static abstract class userImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void register(com.demo.grpc.User.registrationReq request,
        io.grpc.stub.StreamObserver<com.demo.grpc.User.APIRes> responseObserver) {
    ...
    /**
     */
    public void update(com.demo.grpc.User.updateReq request,
        io.grpc.stub.StreamObserver<com.demo.grpc.User.APIRes> responseObserver) {
    ...
    /**
     */
    public void viewProfile(com.demo.grpc.User.viewReq request,
        io.grpc.stub.StreamObserver<com.demo.grpc.User.viewRes> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.demo.grpc.User.registrationReq,
                com.demo.grpc.User.APIRes>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.demo.grpc.User.viewReq,
                com.demo.grpc.User.viewRes>(
  ...
  public static final class userBlockingStub extends io.grpc.stub.AbstractStub<userBlockingStub> {
    ...
    /**
     */
    public com.demo.grpc.User.APIRes register(com.demo.grpc.User.registrationReq request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.demo.grpc.User.APIRes update(com.demo.grpc.User.updateReq request) {
      return blockingUnaryCall(
    ...
    /**
     */
    public com.demo.grpc.User.viewRes viewProfile(com.demo.grpc.User.viewReq request) {
      return blockingUnaryCall(
  ...
  public static final class userFutureStub extends io.grpc.stub.AbstractStub<userFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.demo.grpc.User.APIRes> register(
        com.demo.grpc.User.registrationReq request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.grpc.User.APIRes> update(
        com.demo.grpc.User.updateReq request) {
      return futureUnaryCall(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.grpc.User.viewRes> viewProfile(
        com.demo.grpc.User.viewReq request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_REGISTER:
          serviceImpl.register((com.demo.grpc.User.registrationReq) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.User.APIRes>) responseObserver);
          break;
        case METHODID_UPDATE:
          serviceImpl.update((com.demo.grpc.User.updateReq) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.User.APIRes>) responseObserver);
          break;
        case METHODID_VIEW_PROFILE:
          serviceImpl.viewProfile((com.demo.grpc.User.viewReq) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.User.viewRes>) responseObserver);
          break;
